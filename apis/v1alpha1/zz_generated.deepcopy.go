...
func (in *AkashConfiguration) DeepCopyInto(out *AkashConfiguration) {
	*out = *in
	if in.KeyName != nil {
	...
	if in.KeyringBackend != nil {
		in, out := &in.KeyringBackend, &out.KeyringBackend
		*out = new(string)
		**out = **in
	}
	if in.AccountAddress != nil {
		in, out := &in.AccountAddress, &out.AccountAddress
		*out = new(string)
		**out = **in
	}
	if in.Net != nil {
	...
	if in.ProvidersApi != nil {
		in, out := &in.ProvidersApi, &out.ProvidersApi
		*out = new(string)
		**out = **in
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new AkashConfiguration.
func (in *AkashConfiguration) DeepCopy() *AkashConfiguration {
	if in == nil {
		return nil
	}
