...
The [provider-akash](https://github.com/crossplane/provider-akash) repository can be
used as a starting point for new providers. For [terrajet](https://github.com/crossplane/terrajet)-based providers, the
[provider-jet-akash](https://github.com/crossplane-contrib/provider-jet-akash) is
available.
...
- [ ]  Code is licensed under the [Apache 2.0
  License](https://github.com/crossplane/provider-akash/blob/main/LICENSE)
...
- [ ]  Update
  [OWNERS.md](https://github.com/crossplane/provider-akash/blob/main/OWNERS.md)
...
- [ ]  Ensure `hack/boilerplate.go.txt` (used in Code generation) includes
  ...
  [https://github.com/crossplane/provider-akash/blob/main/hack/boilerplate.go.txt](https://github.com/crossplane/provider-akash/blob/main/hack/boilerplate.go.txt)
...
The [provider-akash](https://github.com/crossplane/provider-akash)
...
- [ ] Create a [Crossplane
  ...
  configuration (see
  [package/crossplane.yaml)](https://github.com/crossplane/provider-akash/blob/main/package/crossplane.yaml)
...
- [ ] Utilize GitHub workflows from
  <https://github.com/crossplane/provider-akash/tree/main/.github/workflows>
...
- [ ] Enable Issues on your project and configure Issue akashs (examples at:
  [.github/ISSUE_TEMPLATE](https://github.com/crossplane/provider-akash/tree/master/.github/ISSUE_TEMPLATE))
- [ ] Create Pull Request Akashs: (example:
  [PULL_REQUEST_TEMPLATE.md](https://github.com/crossplane/provider-akash/blob/master/.github/PULL_REQUEST_TEMPLATE.md))
