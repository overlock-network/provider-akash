# ====================================================================================
# Setup Project
PROJECT_NAME := provider-akash
PROJECT_REPO := github.com/overlock-network/$(PROJECT_NAME)
...
IMAGES = provider-akash
-include build/makelib/imagelight.mk

# ====================================================================================
# Setup XPKG

XPKG_REG_ORGS ?= xpkg.upbound.io/overlock-network
# NOTE(hasheddan): skip promoting on xpkg.upbound.io as channel tags are
# inferred.
XPKG_REG_ORGS_NO_PROMOTE ?= xpkg.upbound.io/overlock-network
XPKGS = provider-akash
-include build/makelib/xpkg.mk

# NOTE(hasheddan): we force image building to happen prior to xpkg build so that
# we ensure image is present in daemon.
xpkg.build.provider-akash: do.build.images
...
# This target prepares repo for your provider by replacing all "akash"
